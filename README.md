...
- [ ] 페이지네이션
- [ ] 모달 제자리에 뜨도록하기
- [ ] Resume <나는 이런사람 입니다> - 기본기를 중요시, 사람을 좋아함, 튀지않음, 대화를 좋아함, 매일 성장하고싶어함, 책임감 투철, 사람에 대해 분석하고 맞춰가는 걸 잘함, 빠른 수용
- [ ] Resume <나는 이런 회사를 선호합니다> - 애정을 가지고 일 할 수 있는 회사, 일하는 보람이 나는 회사, 주인의식을 가질 수 있는 회사
- [ ] Resume <나는 이런 팀을 선호합니다> - 함께 발전, 커뮤니케이션 원활, 협업의 중요성을 아는, JD가 명확한, 하는일이 무엇인지 정확하게 알려주는,
